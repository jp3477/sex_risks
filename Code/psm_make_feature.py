...
def make_features():
    ...
    q = """
        SELECT
            atc_5_id, PID, 1 drug
        FROM user_jp3477.patient_drug_pairs p FORCE INDEX (patient_drug_pairs_safetyreportid)
        JOIN user_pc2800.atc_5_patient_psm psm
    ...
    for drugID in tqdm(drugs):
        ...
        atc_pids_combos_df = unique_pids.to_frame()
